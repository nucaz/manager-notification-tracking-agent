...
> Este archivo es la versión canónica. Se mantiene también como
> `AGENTS.md` y `GEMINI.md` (mismo contenido, para que Claude Code,
> Gemini CLI y cualquier otra herramienta que busque su propio archivo
> de instrucciones lo encuentren sin configuración extra). Si editas
> este archivo, replica el cambio en los otros dos.
