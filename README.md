...
## 7. Integración con GLPI — cómo funciona
...
src/db/               Pool de conexión, migración y seed del usuario admin
src/services/         Cliente GLPI, cliente Gemini (extracción IA), envío de correo, configuración, subida de archivos
src/jobs/              Tarea programada de recordatorios (node-cron)
src/middleware/        Autenticación y control de acceso por rol
src/routes/             Rutas de cada módulo (licencias, dominios, isp, red, adjuntos, glpi, reportes, configuración, usuarios)
